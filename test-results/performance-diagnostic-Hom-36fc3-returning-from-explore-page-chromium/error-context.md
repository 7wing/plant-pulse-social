...
- Name: performance-diagnostic.spec.ts >> Home Page Performance Diagnostic >> check if home refetches when returning from explore page
- Location: e2e/performance-diagnostic.spec.ts:64:3
